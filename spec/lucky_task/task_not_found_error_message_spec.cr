...
describe LuckyTask::TaskNotFoundErrorMessage do
  it "shows 'did you mean' if there is a similar task name" do
    io = IO::Memory.new

    LuckyTask::TaskNotFoundErrorMessage.print("my:col_task", io)
  ...
  it "does not show 'did you mean' if there is no similar task name" do
    ...
    LuckyTask::TaskNotFoundErrorMessage.print("my.task", io)
